...
from tkinter import colorchooser, Tk, Canvas, Frame, Button, Scale, HORIZONTAL, IntVar
...
def colour():
    ...
    COLOUR = hex
col=Button(menu,text='Change colour',command=colour)
...
clear_button = Button(menu,text='CLEAR',command=clear_canvas)
